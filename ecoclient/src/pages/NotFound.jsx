        ...
        <div className='' style={{ backgroundColor: '#b3e3b4' }}>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-row justify-around'>
                    <Link to={"/"} className="w-30 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 text-center">
                        Inicio
                    </Link>
                    <Link to={"/"} className="w-30 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 text-center">
                        Contacto
